...
fn test_pr() -> Result<()> {
    ...
    let url = env::var("GR_GITEA_REPOSITORY_URL")
        .unwrap_or("git@codeberg.org:gr-bin-test/gr-bin-test.git".to_string());
    ...
    // TODO: Approve the PR - GitHub users cannot approve their own PRs
